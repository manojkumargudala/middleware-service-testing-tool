...
public class AdminTasks {
  ...
  private static final BiMap<RequestSpec, Class<? extends AdminTask>> TASKS =
      new ImmutableBiMap.Builder<RequestSpec, Class<? extends AdminTask>>()
          ...
          .put(requestSpec(POST, "/shutdown"), ShutdownServerTask.class).build();

  public static AdminTask taskFor(final RequestMethod method, final String path) {
  ...
  public static RequestSpec requestSpecForTask(final Class<? extends AdminTask> taskClass) {
