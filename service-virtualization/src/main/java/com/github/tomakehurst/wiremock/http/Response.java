...
public class Response {
  ...
  public static Response notConfigured() {
    Response response =
        new Response(HTTP_NOT_FOUND, (byte[]) null, noHeaders(), false, null, false);
    return response;
  }
  ...
  public Response(final int status, final byte[] body, final HttpHeaders headers,
      final boolean configured, final Fault fault, final boolean fromProxy) {
    this.status = status;
    this.body = body;
  ...
  public Response(final int status, final String body, final HttpHeaders headers,
      final boolean configured, final Fault fault, final boolean fromProxy) {
    this.status = status;
    this.headers = headers;
  ...
  public String toString() {
    return "Response [status=" + status + ", body=" + Arrays.toString(body) + ", headers="
        + headers + ", configured=" + configured + ", fault=" + fault + ", fromProxy=" + fromProxy
        + "]";
  }
  ...
  public static class Builder {
    ...
    public Builder configured(final boolean configured) {
      this.configured = configured;
      return this;
    }

    public Builder fault(final Fault fault) {
      this.fault = fault;
      return this;
    }

    public Builder fromProxy(final boolean fromProxy) {
      this.fromProxy = fromProxy;
      return this;
    }
