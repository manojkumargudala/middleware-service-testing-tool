 ...
 * http://download.eclipse.org/jetty/stable-7/apidocs/org/eclipse/
 * jetty/server/AbstractConnector.html
 */
public class JettySettings {
  ...
  public String toString() {
    return "JettySettings{" + "acceptors=" + acceptors + ", acceptQueueSize=" + acceptQueueSize
  ...
  public static class Builder {
    ...
    public JettySettings build() {
      return new JettySettings(Optional.fromNullable(acceptors),
          Optional.fromNullable(acceptQueueSize), Optional.fromNullable(requestHeaderSize));
    }
  }
