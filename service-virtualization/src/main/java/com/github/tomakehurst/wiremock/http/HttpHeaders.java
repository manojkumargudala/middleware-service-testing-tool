...
public class HttpHeaders {
  ...
  public HttpHeaders(final HttpHeader... headers) {
    this(ImmutableList.copyOf(headers));
  }

  public HttpHeaders(final Iterable<HttpHeader> headers) {
  ...
  public static HttpHeaders copyOf(final HttpHeaders source) {
  ...
  public HttpHeaders plus(final HttpHeader... additionalHeaders) {
    return new HttpHeaders(ImmutableList.<HttpHeader>builder().addAll(all())
        .addAll(asList(additionalHeaders)).build());
  }
  ...
  private CaseInsensitiveKey caseInsensitive(final String key) {
    return new CaseInsensitiveKey(key);
  }

  @JsonIgnore
  public Collection<String> getHeaderValue(final String key) {
    return headers.get(caseInsensitive(key));
  }
}
