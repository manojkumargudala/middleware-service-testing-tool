...
public class Jetty6SoapRequestHandlerDispatchingServlet extends HttpServlet {
   ...
   */
  private String getNormalizedMappedUnder(final ServletConfig config) {
  ...
  private boolean getFileContextForwardingFlagFrom(final ServletConfig config) {
  ...
  protected void service(final HttpServletRequest httpServletRequest,
    ...
    System.out.println("the url is " + httpServletRequest.getRequestURI());
  ...
  public static void applyResponse(final Response response,
  ...
  private static void writeAndTranslateExceptions(final HttpServletResponse httpServletResponse,
      final byte[] content) {
    try {
  ...
  private void forwardToFilesContext(final HttpServletRequest httpServletRequest,
      final HttpServletResponse httpServletResponse, final Request request)
