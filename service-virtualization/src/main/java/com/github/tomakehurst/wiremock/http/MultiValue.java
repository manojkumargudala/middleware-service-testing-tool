...
public class MultiValue {
  ...
  public MultiValue(final String key, final List<String> values) {
    this.key = key;
    this.values = values;
  }
  ...
  public boolean containsValue(final String expectedValue) {
  ...
  private boolean anyValueMatches(final ValuePattern valuePattern) {
    return any(values, new Predicate<String>() {
      public boolean apply(final String headerValue) {
