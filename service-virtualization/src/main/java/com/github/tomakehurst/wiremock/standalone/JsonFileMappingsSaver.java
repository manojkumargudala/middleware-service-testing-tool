...
public class JsonFileMappingsSaver implements MappingsSaver {
  ...
  public JsonFileMappingsSaver(final FileSource mappingsFileSource) {
    this.mappingsFileSource = mappingsFileSource;
    idGenerator = new VeryShortIdGenerator();
  }

  public void saveMappings(final StubMappings stubMappings) {
    Collection<StubMapping> transientStubs =
        filter(stubMappings.getAll(), new Predicate<StubMapping>() {
          public boolean apply(final StubMapping input) {
