...
public class ValueMatchingStrategy {
  ...
  public static Function<ValueMatchingStrategy, ValuePattern> toValuePattern =
      new Function<ValueMatchingStrategy, ValuePattern>() {
        public ValuePattern apply(final ValueMatchingStrategy input) {
  ...
  public void setMatchingXPath(final String matchingXPath) {
  ...
  public void setJsonMatchesPath(final String jsonPaths) {
